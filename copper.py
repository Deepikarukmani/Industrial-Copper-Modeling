...
with tab1:    
        ...
        if submit_button and flag==0:
            ...
            import pickle
            with open(r"D:\PYTHON\CopperModeling\model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'D:\PYTHON\CopperModeling\scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"D:\PYTHON\CopperModeling\t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"D:\PYTHON\CopperModeling\s.pkl", 'rb') as f:
